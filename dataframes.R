...
head(stats, n=8)
tail(stats)
str(stats)  # investigate schema and some sample data (str = structure)
...
levels(stats$Income.Group)  # gives distinct vals in a col
...
qplot(data=merged, x=Internet.users, y=Birth.rate, color=Regions,
      size=I(3), shape=I(19), alpha=I(0.7), main='Birth Rate vs Internet Users')
